...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    okBtn.frame = HGCGM(0, 0, 200.0, 40.0);
...
- (void)layoutSubviews {
    ...
    self.titleLabel.frame = HGCGM(20, 0, self.width-100.0, 50.0);
    self.foldBtn.frame = HGCGM(self.width-80.0, 0, 80.0, 50);
    
    self.collectionView.frame = HGCGM(0, 50.0, self.width, self.height-100.0);
    
    self.okBtn.frame = HGCGM((self.width-self.okBtn.width)*0.5, self.height-50.0, self.okBtn.width, self.okBtn.height);
}
