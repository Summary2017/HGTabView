...
- (void)setupSubviews {
    ...
    contentView.frame = HGCGM(0, tabView.height, self.width, self.height);
...
- (void)layoutSubviews {
    ...
    self.tabView.frame = HGCGM(0, 0, self.width, 50.0);
    self.contentView.frame = HGCGM(0, 50.0, self.width, self.height-50.0);
}
